...
-- instead of writing same again and again we use OR
...
SELECT * FROM retail_sales WHERE sale_date='2022-11-05' --and  price_per_unit> 300

-- Que 2.Write a SQL query to retrieve all transactions where the category 
...
-- Que 4. Write a SQL query to find the average age of customers who purchased 
...
-- Que 6. Write a SQL query to find the total number of transactions (transaction_id) 
...
-- Que. 7. Write a SQL query to calculate the average sale for each month. 
...
-- Que. 9 Write a SQL query to find the number of unique customers who purchased 
...
-- Que 10.Write a SQL query to create each shift and number of orders 
